...
_G.packer_plugins = {
  ...
  ["tailwind-sorter.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/tailwind-sorter.nvim",
